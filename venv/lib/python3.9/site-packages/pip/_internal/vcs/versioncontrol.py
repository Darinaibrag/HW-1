...
def make_vcs_requirement_url(repo_url, rev, project_name, subdir=None):
    ...
    Args:
      ...
      project_name: the (unescaped) taskAPI name.
    """
...
def find_path_to_project_root_from_repo_root(location, repo_root):
    ...
    """
    Find the the Python taskAPI's root by searching up the filesystem from
    `location`. Return the path to taskAPI root relative to `repo_root`.
    Return None if the taskAPI root is `repo_root`, or cannot be found.
    """
    # find taskAPI root.
    ...
    while not is_installable_dir(location):
        ...
        if location == last_location:
            ...
            # finding a Python taskAPI.
            logger.warning(
                "Could not find a Python taskAPI for directory %s (tried all "
                "parent directories)",
                orig_location,
            )
            return None
...
class VersionControl:
    ...
    def get_subdirectory(cls, location):
        ...
        """
        Return the path to Python taskAPI root, relative to the repo root.
        Return None if the taskAPI root is in the repo root.
        """
        return None
