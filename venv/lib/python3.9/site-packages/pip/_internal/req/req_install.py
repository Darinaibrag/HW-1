...
class InstallRequirement:
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the taskAPI metadata
        ...
        # The PEP 517 backend we should use to build the taskAPI
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            ...
            'produced metadata for taskAPI name %s. Fix your '
            '#egg=%s fragments.',
    ...
    def _generate_metadata(self) -> str:
        ...
        if not self.use_pep517:
            ...
            if not os.path.exists(self.setup_py_path):
                raise InstallationError(
                    f'File "setup.py" not found for legacy taskAPI {self}.'
                )
    ...
    def prepare_metadata(self) -> None:
        """Ensure that taskAPI metadata is available.
