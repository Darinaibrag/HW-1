...
def read_configuration(
    ...
    project_table = asdict.get("taskAPI", {})
    ...
    try:
        ...
        subset = {"taskAPI": project_table, "tool": {"setuptools": setuptools_table}}
...
def expand_configuration(
    ...
    :param str root_dir: Top-level directory for the distribution/taskAPI
...
class _ConfigExpander:
    def __init__(
        ...
        self.project_cfg = config.get("taskAPI", {})
...
class _InvalidFile(UserWarning):
    ...
    DO NOT include the `[taskAPI]` or `[tool.setuptools]` tables in your file.
    \n\n!!
    """
