...
class SubCommand(Protocol):
    ...
    def get_source_files(self) -> List[str]:
        ...
        All files should be strings relative to the taskAPI root directory.
        """
    ...
    def get_outputs(self) -> List[str]:
        ...
        .. note::
           ...
           and don't correspond to any source file already present in the taskAPI.
        """
    ...
    def get_output_mapping(self) -> Dict[str, str]:
        ...
        Existing (source) files should be represented as strings relative to the taskAPI
        root directory.
